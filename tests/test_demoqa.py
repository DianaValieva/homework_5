...
def test_submit(open_browser):
    ...
    browser.element('#userNumber').should(be.blank).type("79879999999")
    ...
    browser.element('#subjectsInput').should(be.blank).type("some Subject")
    ...
    browser.element('.table').should(have.text('Diana Valieva' and 'di7051@gmail.com' and
                                               '79879999999' and '30 December,1991' and 'ufa' and "NCR Delhi"))
